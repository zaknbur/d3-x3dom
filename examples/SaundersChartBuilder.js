	...
	var my = function my(selection) {
		selection.each(function () {
			...
			if (tickFormat !== "") {
				...
				})).append("billboard").attr("axisofrotation", "0 0 0").append("shape").call(makeSolid, "black").append("text").attr("string", tickFormat).append("fontstyle").attr("size", 2.0).attr("family", "SANS").attr("style", "BOLD").attr("justify", "MIDDLE");
